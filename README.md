...
**Warning: This oepration can take long time because of both Git histories and file trees parsing**
...
**You should also have your _git_ environment ready i.e. add your SSH private key if you clone by SSH for example. _gh_ must be installed, and python3 be ready. Obvisously _gitleaks_ must be installed**